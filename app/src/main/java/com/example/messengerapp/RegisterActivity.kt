            ...
            mAuth.createUserWithEmailAndPassword(email,password)
                .addOnCompleteListener {task ->
                    ...
                    if(task.isSuccessful)
                    {
                        ...
                        userHashMap["profile"] = "https://firebasestorage.googleapis.com/v0/b/messengera-6b109.appspot.com/o/profile.png?alt=media&token=65a041fd-96ea-4539-97e0-a567c1e74c2d"
                        userHashMap["cover"] = "https://firebasestorage.googleapis.com/v0/b/messengera-6b109.appspot.com/o/cover.jpg?alt=media&token=99151969-da78-4f58-b317-accd0e7bc8ab"
                    ...
                    else
                    {
                        ...
                        Toast.makeText(this@RegisterActivity, "Mensaje Error:" + task.exception!!.message.toString(), Toast.LENGTH_LONG).show()
                    }
                }
        }
    }
